                        ...
                        <div class="content content-popup">
                            ...
                            <div class="card-footer">
                                <div class="share-buttons">
                                    ...
                                    <a target="_blank" class="btn-share-tw" onclick="gaShareButtonEvent({{$link->id}}, 'Twitter', '{{$link->creator}}/{{$link->short_url}}');" href="https://twitter.com/intent/tweet?url={{env('APP_PROTOCOL') . env('APP_ADDRESS')}}/{{$link->creator}}/{{$link->short_url}}" data-url="{{env('APP_PROTOCOL') . env('APP_ADDRESS')}}/{{$link->creator}}/{{$link->short_url}}" data-id="{{$link->id}}"><i id="social-tw" class="fa fa-twitter-square fa-2x social"></i></a>
